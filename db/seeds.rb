...
Faker::Address.street_address, zipy_code: Faker::Address.zip_code, city: Faker::Address.city, country_code: Faker::Address.country_code, phone_number: Faker::PhoneNumber.phone_number)
end
